page 11147693 "IDYS S.Ord Carrier Select"
{
    Caption = 'Carrier Select';
    Editable = false;
    PageType = List;
    SourceTable = "IDYS S.Ord Carrier Select";
    UsageCategory = None;
    ContextSensitiveHelpPage = '23199761';
    ObsoleteReason = 'Merged with page 11147689 "IDYS Carrier Select"';
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                ...
                field("Price as Decimal"; Rec."Price as Decimal")
                {
