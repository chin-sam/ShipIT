tableextension 11147653 "IDYS Transfer Shpt. Line Ext." extends "Transfer Shipment Line"
{
    fields
    {
    ...
    local procedure IDYSOnBeforeQtyToSendError(TransferShipmentLine: Record "Transfer Shipment Line"; var IsHandled: Boolean);
    begin
    end;
}