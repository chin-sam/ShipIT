pageextension 11147686 "IDYS Sales Quote" extends "Sales Quote"
{
    layout
    {
        ...
        addafter("Shipping Agent Service Code")
        {
            ...
            group(IDYSDeliveryHub)
            {
                ...
                field(IDYSOpenServices; IDYSOpenService)
                {
                    ...
                    begin
                        SelectServiceLvlOther.SetParameters(Database::"Sales Header", "IDYS Source Document Type"::"0", Rec."No.", Rec.IDYSGetShipFromCountryCode(), Rec."Ship-to Country/Region Code", Rec.SystemId);
        ...
        addafter(SalesLines)
        {
            part("IDYS Sales Quote Pck. Sub."; "IDYS Sales Quote Pck. Sub.")
            {
                ApplicationArea = All;
    ...
    begin
        ...
        CurrPage."IDYS Sales Quote Pck. Sub.".Page.SetProvider(Rec."IDYS Provider");
