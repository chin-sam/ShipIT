page 11147737 "IDYS Sales Quote Pck. Sub."
{
    Caption = 'Sales Quote Packages';
    PageType = ListPart;
    SourceTable = "IDYS Source Document Package";
    SourceTableView = where("Document Type" = const("0"));
    ...
    procedure SetVisibilityForSalesQuote(NewIsSendCloud: Boolean; NewIsDeliveryHub: Boolean; NewIsTranssmart: Boolean; NewIsEasyPost: Boolean)
    begin
    end;

    [Obsolete('New parameter added', '21.0')]
    procedure SetVisibilityForSalesQuote(NewIsSendCloud: Boolean; NewIsDeliveryHub: Boolean; NewIsTranssmart: Boolean)
    begin
    end;
