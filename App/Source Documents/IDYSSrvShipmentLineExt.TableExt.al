tableextension 11147652 "IDYS Srv. Shipment Line Ext." extends "Service Shipment Line"
{
    fields
    {
        ...
        field(11147640; "IDYS Quantity Sent"; Decimal)
        {
            ...
            CalcFormula = sum("IDYS Transport Order Line"."Qty. (Base)" where("Source Document Table No." = const(5990),
    ...
    local procedure IDYSOnBeforeQtyToSendError(ServiceShipmentLine: Record "Service Shipment Line"; var IsHandled: Boolean);
    begin
    end;
}