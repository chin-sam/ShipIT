tableextension 11147648 "IDYS Sales Shpt. Line Ext." extends "Sales Shipment Line"
{
    fields
    {
        ...
        field(11147640; "IDYS Quantity Sent"; Decimal)
        {
            ...
            CalcFormula = sum("IDYS Transport Order Line"."Qty. (Base)" where("Source Document Table No." = const(110),
    ...
    local procedure IDYSOnBeforeQtyToSendError(SalesShipmentLine: Record "Sales Shipment Line"; var IsHandled: Boolean);
    begin
    end;
}