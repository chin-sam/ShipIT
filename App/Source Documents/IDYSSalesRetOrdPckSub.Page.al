page 11147738 "IDYS Sales Ret. Ord. Pck. Sub."
{
    Caption = 'Sales Return Order Packages';
    PageType = ListPart;
    SourceTable = "IDYS Source Document Package";
    SourceTableView = where("Document Type" = const("5"));
    ...
    procedure SetVisibilityForSalesRetOrder(NewIsSendCloud: Boolean; NewIsDeliveryHub: Boolean; NewIsTranssmart: Boolean; NewIsEasyPost: Boolean)
    begin
    end;

    [Obsolete('New parameter added', '21.0')]
    procedure SetVisibilityForSalesRetOrder(NewIsSendCloud: Boolean; NewIsDeliveryHub: Boolean; NewIsTranssmart: Boolean)
    begin
    end;
