tableextension 11147644 "IDYS Service Header Extension" extends "Service Header"
{
    fields
    {
                ...
                if CurrFieldNo = FieldNo("Location Code") then
                    if "IDYS Provider" = "IDYS Provider"::"Delivery Hub" then
                        if "Location Code" <> xRec."Location Code" then begin
                            ...
                            IDYSSourceDocumentService.SetDefaultServices(Database::"Service Header", "IDYS Source Document Type"::"1", "No.", IDYSShippAgentSvcMapping, IDYSGetShipFromCountryCode(), "Ship-to Country/Region Code", SystemId);
                        end;
            end;
        }
        ...
        modify("Shipping Agent Service Code")
        {
            ...
            begin
                ...
                if Rec."Document Type" = Rec."Document Type"::Order then
                    IDYSSourceDocumentService.SetDefaultServices(Database::"Service Header", "IDYS Source Document Type"::"1", "No.", ShippAgentSvcMapping, IDYSGetShipFromCountryCode(), "Ship-to Country/Region Code", SystemId);
            end;
        }
        ...
        field(11147643; "IDYS Requested Delivery Date"; Date)
        {
        ...
        field(11147704; "IDYS No. of Selected Services"; Integer)
        {
            ...
            CalcFormula = count("IDYS Source Document Service" where("Table No." = const(5900), "Document Type" = field("Document Type"), "Document No." = field("No.")));
        }
    ...
    local procedure IDYSOnBeforeModifyOnAfterInsert(var ServiceHeader: Record "Service Header"; var DontModify: Boolean)
    begin
    end;
