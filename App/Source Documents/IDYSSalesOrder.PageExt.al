pageextension 11147640 "IDYS Sales Order" extends "Sales Order"
{
    layout
    {
        ...
        addafter("Shipping Agent Service Code")
        {
            ...
            group(IDYSDeliveryHub)
            {
                ...
                field(IDYSOpenServices; IDYSOpenService)
                {
                    ...
                    begin
                        SelectServiceLvlOther.SetParameters(Database::"Sales Header", "IDYS Source Document Type"::"1", Rec."No.", Rec.IDYSGetShipFromCountryCode(), Rec."Ship-to Country/Region Code", Rec.SystemId);
        ...
        addafter(SalesLines)
        {
            part("IDYS Sales Order Pck. Sub."; "IDYS Sales Order Pck. Sub.")
            {
                ApplicationArea = All;
        ...
        addfirst(FactBoxes)
        {
            ...
            part("IDYS Packages"; "IDYS Sales Order Pck. Sub.")
            {
                Caption = 'Packages';
                SubPageLink = "Table No." = const(36), "Document Type" = field("Document Type"), "Document No." = field("No.");
                ...
                ObsoleteReason = 'Changed to Source Doc. Pck. Factbox';
                ObsoleteTag = '21.0';
                Visible = false;
            }
    ...
    begin
        ...
        CurrPage."IDYS Sales Order Pck. Sub.".Page.SetProvider(Rec."IDYS Provider");
