tableextension 11147647 "IDYS Sales Shpt. Header Ext." extends "Sales Shipment Header"
{
    fields
    {
        ...
        field(11147704; "IDYS No. of Selected Services"; Integer)
        {
            ...
            CalcFormula = count("IDYS Source Document Service" where("Table No." = const(110), "Document No." = field("No.")));
        }
