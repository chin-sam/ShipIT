pageextension 11147690 "IDYS Posted Transfer Receipt" extends "Posted Transfer Receipt"
{
    layout
    {
        addfirst(FactBoxes)
        ...
        addbefore("&Navigate")
        {
            group("IDYS ShipIT Actions")
            {
                ...
                action("IDYS Create Transport Order")
                {
                    ...
                    begin
                        IDYSDocumentManagement.TransferReceipt_CreateTransportOrder(Rec, false);
                    end;
                }
            }
        }
                ...
                action("IDYS Transport Orders")
                {
                    ...
                    begin
                        if ShowUnpostedTO then begin
                            ...
                            IDYSDocumentMgt.FindAndOpenTransportOrdersFromSource(Database::"Transfer Receipt Header", 0, Rec."No.");
                    end;
                }
