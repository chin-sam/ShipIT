pageextension 11147683 "IDYS Purchase Order" extends "Purchase Order"
{
    layout
    {
            ...
            group("IDYS ShipIT Fields")
            {
                ...
                group(IDYSDeliveryHub)
                {
                    ...
                    field(IDYSOpenServices; IDYSOpenService)
                    {
                        ...
                        begin
                            SelectServiceLvlOther.SetParameters(Database::"Purchase Header", "IDYS Source Document Type"::"1", Rec."No.", Rec.IDYSGetShipFromCountryCode(), Rec."Ship-to Country/Region Code", Rec.SystemId);
