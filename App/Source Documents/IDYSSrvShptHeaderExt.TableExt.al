tableextension 11147651 "IDYS Srv. Shpt. Header Ext." extends "Service Shipment Header"
{
    fields
    {
        ...
        field(11147704; "IDYS No. of Selected Services"; Integer)
        {
            ...
            CalcFormula = count("IDYS Source Document Service" where("Table No." = const(5990), "Document No." = field("No.")));
        }
